...
Using at ST-LINK programmer, for example STM32CubeProgrammer, connect using ST-LINK and write the compiled bootloader at start address `0x08000000` *(default)*.

## First boot
After flashing the bootloader, you may reassemble the board. At first connection, a UF2 drive will show up. Simply copy *(as normally)* the compiled QMK firmware. At this point you should have a working keyboard. If you'd ever need to flash again, you can enter the bootloader as normally: unplug, hold escape, replug.
